...
class FtxClient:
    ...
    #moja metoda
    #def get_dupa (self, marketDupa:str):
        #return self._get(f"markets/{marketDupa}/trades")
    ...
    #get_index_candles
    def get_historical_future_candles(
        self, market: str, resolution: int = 300, start_time: float = None,
        end_time: float = None
    ) -> List[dict]:
    ...
    #pobiera 2050 wygasłych kontraktów terminowych - chyba nie można pobrać tylko jednego
