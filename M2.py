...
class M2bot:
    ...
    def __init__(self, market: str, fee: float, gap_long, gap_short, gap_profit_long, gap_profit_short, refresh_time ):
        self.dt = datetime
        ...
        #tu powinno być last result jako element obiektu
    ...
    def start_bot(self):
        ...
        while initialize_while:
            ...
            if ask_last >= long_price_will:
                ...
                trade = ("long", ask_last, date_time_current)
